...
function DashboardCard({ eyebrow, title, description, children, className = "" }) {
  return (
    <section
      className={`dashboard-surface relative overflow-hidden rounded-[28px] border border-slate-300/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(239,244,249,0.98)_100%)] p-4 shadow-[0_28px_82px_-44px_rgba(15,23,42,0.26)] ring-1 ring-slate-100/90 backdrop-blur-sm sm:rounded-[30px] sm:p-5 lg:rounded-[32px] lg:p-7 ${className}`.trim()}
    >
      ...
      {(eyebrow || title || description) && (
        <SectionHeading
          className="relative mb-5 sm:mb-6 lg:mb-7"
